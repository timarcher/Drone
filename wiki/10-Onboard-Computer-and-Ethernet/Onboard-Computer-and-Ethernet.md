This page contains details on the installation of a Raspberry Pi companion computer and the setup of a BotBlox SwitchBlox Ethernet switch to create a network onboard the drone.
